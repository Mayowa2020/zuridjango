...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Bookie\Documents\Python\zuritraining\zurienv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Bookie\Documents\Python\zuritraining\zurienv\Scripts\deactivate.nu'
